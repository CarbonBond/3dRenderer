...
void render(void){
  ...
  for(int i = 0; i < (array_length(triangles_to_render)); i++){
    ...
    draw_rect(triangle.points[0].x, triangle.points[0].y, 2, 2, 0xFFFF00AA);
    draw_rect(triangle.points[1].x, triangle.points[1].y, 2, 2, 0xFFFF00AA);
    draw_rect(triangle.points[2].x, triangle.points[2].y, 2, 2, 0xFFFF00AA);
